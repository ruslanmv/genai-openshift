"""Utility script for downloading Docling and OCR models into a container image.

This script pre-downloads the Docling model snapshot and EasyOCR language
packs so that Docling-based services start quickly when deployed on
OpenShift.
"""
