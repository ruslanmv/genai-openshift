"""Gradio front-end for the Docling Serve workbench.

The UI lets users upload or link to documents, run them through Docling, and
explore the extracted structure and content as part of GenAI and RAG flows
on OpenShift.
"""
