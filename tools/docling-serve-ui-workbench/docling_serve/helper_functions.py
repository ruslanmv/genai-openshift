"""Helper utilities for the Docling Serve FastAPI and Gradio layers.

This module includes helpers for building FastAPI ``Form`` dependencies and
for parsing and normalising user inputs coming from the UI.
"""
