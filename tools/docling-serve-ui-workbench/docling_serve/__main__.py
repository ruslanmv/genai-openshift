"""Command line entry point for the Docling Serve UI/Workbench.

The Typer-based CLI starts the FastAPI/Gradio service, making it simple to
launch a local or containerised Docling workbench in OpenShift environments.
"""
