"""FastAPI application for the Docling Serve UI/Workbench.

This module wires together the Docling backend, static assets and notebook‑
style APIs into a single FastAPI app that can be run locally or on
OpenShift as part of a broader GenAI toolchain.
"""
