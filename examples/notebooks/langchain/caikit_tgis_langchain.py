"""LangChain integration for caikit/TGIS text-generation models on OpenShift.

This module defines the ``CaikitLLM`` class, a LangChain-compatible LLM
wrapper that routes prompts to caikit-nlp inference services (TGIS) running
on Red Hat OpenShift AI / Open Data Hub.
"""
