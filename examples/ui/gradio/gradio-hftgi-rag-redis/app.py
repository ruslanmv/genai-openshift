"""Gradio RAG demo using Hugging Face TGI and Redis as a vector database.

This example wires a TGI text‑generation service on OpenShift AI to a Redis
vector store, illustrating a complete GenAI stack for question answering
