"""Gradio chat UI backed by Hugging Face TGI with basic conversation memory.

This example connects to a text-generation-inference (TGI) server exposed
from OpenShift AI and demonstrates how to build a lightweight GenAI chat
experience with conversational state managed in memory.
"""
