"""Gradio RAG demo using Hugging Face TGI and PostgreSQL/pgvector.

The app shows how to combine a TGI-hosted LLM running on OpenShift AI with
a PostgreSQL database configured with the pgvector extension to implement
retrieval‑augmented generation over your own knowledge base.
"""
