"""LangChain Milvus retriever with a configurable score threshold.

This helper defines a custom retriever that filters Milvus search results
based on a similarity score threshold before passing documents into a RAG
chain, improving answer quality for OpenShift-hosted GenAI apps.
"""
import warnings
