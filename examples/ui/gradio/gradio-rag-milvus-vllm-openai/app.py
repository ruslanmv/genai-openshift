"""Gradio RAG demo using Milvus and a vLLM OpenAI-compatible endpoint.

The UI queries embeddings stored in a Milvus vector database and sends the
retrieved context to a vLLM server that exposes an OpenAI‑style chat/completions
API, as typically deployed on OpenShift AI.
"""
