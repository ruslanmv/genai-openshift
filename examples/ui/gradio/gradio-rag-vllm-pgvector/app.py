"""Gradio RAG demo using vLLM and PostgreSQL/pgvector.

The application connects to a vLLM model server exposing an OpenAI‑compatible
API and a pgvector‑enabled PostgreSQL instance to deliver a full RAG workflow
suitable for OpenShift AI deployments.
"""
