"""Gradio RAG demo using caikit/TGIS for generation and Redis as a vector store.

This application exposes a chat-style interface for retrieval‑augmented
generation (RAG) against content indexed in Redis, calling a caikit/TGIS
LLM endpoint deployed on Red Hat OpenShift AI.
"""
